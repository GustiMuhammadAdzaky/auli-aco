...
public class Ant implements Callable<Ant> {
    public static final double Q = 0.0005; //parameter used for adjusting the amount of phermone deposited. The value is between 0 and 1
    ...
    public acofortsp.Route getRoute() { return route; }
